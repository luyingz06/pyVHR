...
def GUI_MENU():
    col1 = [[sg.Text("Set Parameters:")],
            ...
            [sg.Text("Skin Extractor:"),
             ...
             sg.Radio("HSV", "RADIO2", default=False, key="-skinHSV-")],
            [sg.Text("ROI:"),
    ...
    while True:
        ...
        if event == '-APPLY-':
            ...
            Params.skin_extractor = 'convexhull' if bool(values['-skinConvex-']) else 'faceparsing' if bool(
                values['-skinFaceParsing-']) else 'hsv'
